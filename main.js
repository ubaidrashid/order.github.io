...
var fruit = []
let fruitNames = ["apple", "banana", "orange", "grape", "kiwi"];

for (let i = 0; i < fruitNames.length; i++) {
    fruit.push(fruitNames[i])
}
...
console.log("Sum of the first 10 natural numbers:", sumOfFirst10);
...
// Q =9
 let reversedColors = colors.reverse();
  ...
  console.log("Reversed Colors array:", reversedColors);
